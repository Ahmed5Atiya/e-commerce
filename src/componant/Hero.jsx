...
function Hero() {
  return (
    <section
      id="home"
      className="w-full gap-10 flex flex-col xl:flex-row  my-10 pb-14  min-h-screen max-container justify-center"
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full  max-xl:padding-x ">
        ...
        <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold">
          ...
          <br />
          <span className="text-coral-red inline-block mt-3">Product</span> Info
        </h1>
        ...
        <div
          className={` flex justify-center cursor-pointer  items-center gap-3 px-7 py-4 border font-montserrat text-lg leading-none`}
        >
          More
